...
namespace NuGet.PackageManagement.VisualStudio
{
    public static class VsProjectReferenceUtility
    {
            ...
            ExternalProjectReferenceContext context)
        {
            ...
            var rootProjectPath = EnvDTEProjectUtility.GetFullProjectPath(rootProject);

            // start with the current project
            toProcess.Push(new DTEReference(rootProject, rootProjectPath));
